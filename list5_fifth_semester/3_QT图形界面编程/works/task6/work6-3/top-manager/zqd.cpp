...
void ZQD::on_sellBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void ZQD::on_buyBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void ZQD::on_addBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}

void ZQD::on_queryBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void ZQD::on_passwordBtn_clicked()
{
...
// Type change
void ZQD::on_sellTypeComboBox_currentIndexChanged(const QString type)
{
    if (type == "请选择类型") {
        // set other part state
        on_sellCancelBtn_clicked();
    } else {
...
void ZQD::on_goodsTypeComboBox_currentIndexChanged(const QString type)
{
    if (type == "请选择类型") {
...
void ZQD::on_newTypeComboBox_currentIndexChanged(const QString type)
{
    if (type == "请选择类型") {
...
void ZQD::on_queryTypeComboBox_currentIndexChanged(const QString type)
{
    if (type == "请选择类型") {
        ui->queryBrandComboBox->setEnabled(false);
    } else {
...
void ZQD::on_sellBrandComboBox_currentIndexChanged(QString brand)
{
...
void ZQD::on_goodsBrandComboBox_currentIndexChanged(QString brand)
{
...
void ZQD::on_newBrandComboBox_currentIndexChanged(QString str)
{
    if (str == "") {
...
void ZQD::on_sellNumSpinBox_valueChanged(int value)
{
    if (value == 0) {
        ui->sellSumLineEdit->clear();
        ui->sellSumLineEdit->setEnabled(false);
...
void ZQD::on_goodsNumSpinBox_valueChanged(int value)
{
    if (value == 0) {
        ui->goodsSumLineEdit->clear();
        ui->goodsSumLineEdit->setEnabled(false);
...
void ZQD::on_newNumSpinBox_valueChanged(int value)
{
...
// goods add
void ZQD::on_newPriceSpinBox_valueChanged(int value)
{
...
void ZQD::on_goodsOkBtn_clicked()
{
...
void ZQD::on_sellCancelBtn_clicked()
{
...
void ZQD::on_goodsCancelBtn_clicked()
{
...
void ZQD::on_newCancelBtn_clicked()
{
...
void ZQD::on_queryPushButton_clicked()
{
...
// password modify
void ZQD::on_changePwdBtn_clicked()
{
...
void ZQD::on_newBrandLineEdit_textChanged(const QString str)
{
    if (str == "") {
        ui->newCancelBtn->setEnabled(false);
        ui->newPriceSpinBox->setEnabled(false);
